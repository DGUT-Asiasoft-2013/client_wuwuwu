...
public class MeFragment extends Fragment implements View.OnClickListener{
   ...
   // AvatarView my_avatarview;
    ...
    public void findview(){
        ...
        photo_tongyong_iv.setImageResource(R.drawable.qr_code);
        photo_tongyong_text.setText("相片");
        collect_tongyong_iv.setImageResource(R.drawable.ic_launcher);
        collect_tongyong_text.setText("收藏");
        wallet_tongyong_iv.setImageResource(R.drawable.qr_code);
        wallet_tongyong_text.setText("钱包");
        setting_tongyong_iv.setImageResource(R.drawable.ic_launcher);
